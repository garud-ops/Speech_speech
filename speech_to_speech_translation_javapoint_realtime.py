...
#Creating a tuple of all the languages mapped with their code

# print(googletrans.LANGUAGES)          #this prints all languages present in googletrans
#Creating the tuple of languages
...
# 1 Taking the voice commands from the user end
...
# 3 Taking the voice input from the user end.
# Here, we will take the user's voice input from the user end  
query_1 = take_command()  
while (query_1 == "None"):  
    query_1 = take_command()

# 3 Implementing the input destination language from the user end, and Map user input with the language code.
def destination_language():  
    print("Please enter the language in which you want to convert the above input \  : Ex. English, Hindi, German, French etc.")  
    print()  
    
# 6  Now, we will implement the input destination language in which the user  
...
# 5 Now, we will map the input destination language with the code  
...
# 6 Now we will invoke the Translator.
# Here, we will invoke the Google Translator  
translator1 = Trans()  


# 7 Now, we will translate from src to dest
...
speak.save(r"C:\\Users\\Rgarud\\Desktop\\cloudstrats\\Speech_to_speech\\captured_JTP_voice.mp3" )  
    
# Now at last, we will be using the OS module for running the translated voice.  
PS(r"C:\\Users\\Rgarud\\Desktop\\cloudstrats\\Speech_to_speech\\captured_JTP_voice.mp3")  
os.remove(r"C:\\Users\\Rgarud\\Desktop\\cloudstrats\\Speech_to_speech\\captured_JTP_voice.mp3")  
print(text1) 
